            ...
            <div className={cx('Modal_login')}>
                {checkRegister ? (
                    <div className={cx('Modal_login_container')}>
                        <h1>Đăng ký</h1>
                        <form onSubmit={(e) => handleSubmitRegister(e)} className={cx('Modal_login_input_list')}>
                            <input value={phone} onChange={(e) => setPhone(e.target.value)} type='number' placeholder='Số điện thoại' required = " " />
                    ...
                    <form onSubmit={(e) => handleClickLogin(e)} className={cx('Modal_login_container')}>
                        ...
                        <div className={cx('Modal_login_input_list')}>
                            <input value={phone} onChange={(e) => setPhone(e.target.value)} type='number' placeholder='Số điện thoại' required = " " />
                            <input value={pass} onChange={(e) => setPass(e.target.value)} type='password' placeholder='Mật khẩu' required = " " />
