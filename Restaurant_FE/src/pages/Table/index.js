...
function App() {
    ...
    // Các hàm xử lý
    const handleClickOpenTable = async (Id, Name, Status) => {
        try {
            if (Status === 'Đang Dùng') {
    ...
    const handleClickCheckout = (Price) => {
        socketOrder.emit('checkoutsuccess', Price, tableId)
            ...
            <div className="Table_Container">
                ...
                <div className='Table_content'>
                    {tables.map((table, index) => (
                        <div onClick={() => handleClickOpenTable(table.Id, table.Name, table.Status)} key={index} className='Table_item'>
                            <h2>{table.Name}</h2>
            ...
            <div ref={RefTable} onClick={handleClickRemoveShowBill} className='modal_detailbillorder'>
                <div onClick={(e) => e.stopPropagation()} className='detailbill_content'>
                    ...
                    <div className='detailbill_content-footer'>
                        ...
                        <div onClick={() => handleClickCheckout(totalPay[0])} className='button_checkout_billorder'>
