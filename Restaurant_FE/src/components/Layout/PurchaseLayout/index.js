...
import Avt from '../../../Asset/images/avtmale.png'
                                        ...
                                        <div key={i}>
                                            ...
                                            {comment[i].Star !== null ? (
                                                ...
                                                <div className={cx('comment_container_star')}>
                                                    ...
                                                    <div className={cx('text_comment')}>
                                                        <textarea required=" " ref={e => containtCmt.current[i] = e} className={cx('comment-input')} spellCheck={false} placeholder="Nhập bình luận và đánh giá của bạn..."></textarea>
                                                    </div>
