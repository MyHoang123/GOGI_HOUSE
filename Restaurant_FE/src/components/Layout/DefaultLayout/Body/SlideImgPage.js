        ...
        <div className={cx('SlideImgPage_Container')}>
            <div className={cx('SlideImgPage_Container_contain')}>
                ...
                <div className={cx('SlideImgPage_Container_contain_img')}>
                    <img className={cx('SlideImgPage_Container_contain_img-item')} src={(bodyimg.length !== 0 ? (`http://localhost:8080/api/v12/bodyimg/${bodyimg[0].Img}`) : (null))} />
                </div>
                <div className={cx('SlideImgPage_Container_contain_img-mini')}>
                    <img src={(bodyimg.length !== 0 ? (`http://localhost:8080/api/v12/bodyimg/${bodyimg[1].Img}`) : (null))} className={cx('SlideImgPage_Container_contain_img-mini-left')} />
                    <img src={(bodyimg.length !== 0 ? (`http://localhost:8080/api/v12/bodyimg/${bodyimg[2].Img}`) : (null))} className={cx('SlideImgPage_Container_contain_img-mini-right')} />
                </div>
            </div>
        </div>
    );
