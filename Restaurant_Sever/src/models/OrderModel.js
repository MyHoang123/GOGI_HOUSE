...
const createbillproductOrder = async (values,result) => {
    db.query(`INSERT INTO detailbillorder (IdBill, IdProduct, Quantity, Price, Status, Note) VALUES ${values};`, function(err,data){
        if(err || data.length <= 0) {
