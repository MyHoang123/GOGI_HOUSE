...
exports.AllBIll = async (req, res) => {
   ...
   const StartPromise = async () => {
    ...
    delete AllBill.AllCountl
        return res.status(200).json({
            massege: 'Thanh cong',
            AllBill: AllBill.AllCount !== null && AllBill.Since_last_week !== null ? AllBill : {AllCount: 0,Since_last_week: 0},
            TotalAll: PriceBill.AllCount !== null && PriceBill.Since_last_week !== null ? PriceBill : {AllCount: 0,Since_last_week: 0}
